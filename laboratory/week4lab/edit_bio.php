<!--
    Muhammad Aiman bin Abdollah
    A175054, Faculty of Technology and Information Science.
  ...
  <!-- <table border="1">
    ...
    <form action="validate_biodata.php" method="post" enctype="multipart/form-data">
     ...
     echo "checked";
        ...
        <hr>
        <input type="hidden" name="matricnum" value="a175054">
        <input type="submit" name="biodata_form" value="Submit My Biodata">&nbsp;<input type="reset" value="Clear" />
    </form>
