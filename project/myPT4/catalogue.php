...
<html lang="en">
  <head>
    ...
    <title>Camerasque Store : Search</title>
      ...
      <form action="catalogue.php" method="get" >
              ...
              <div class="btn-group" style="width: 100%;">
                ...
                <?php try {
                  ...
                  $stmt = $conn->prepare("SELECT DISTINCT fld_product_user_level FROM tbl_products_a175054");
                ...
                <ul class="dropdown-menu" style="width: 100%;">
                  ...
                  <li><a href="catalogue.php?category=<?php echo $readrow['fld_product_user_level']; ?>"><?php echo $readrow['fld_product_user_level']; ?></a></li>
                  <?php
                    }
                    $conn = null;
                  ?>
                    ...
                    try {
                      ...
                      if(isset($_GET['search'])) {
                        ...
                        if ($getSearch == "all") {
                          ...
                          $stmt = $conn->prepare("SELECT * FROM tbl_products_a175054 WHERE fld_product_name LIKE '%".$getSearch."%'");
                        }

                      } else if(isset($_GET["category"])){
                        $getCategory = $_GET["category"];
                        $stmt = $conn->prepare("SELECT * FROM tbl_products_a175054 WHERE fld_product_user_level = \"".$getCategory."\"");

                      } else if (isset($_GET["sort"])) {
                        $getSort = $_GET["sort"];

                        if($getSort == "nameAsc"){
                          $stmt = $conn->prepare("SELECT * FROM tbl_products_a175054 ORDER BY fld_product_name ASC");
                        } elseif ($getSort == "nameDesc") {
                          $stmt = $conn->prepare("SELECT * FROM tbl_products_a175054 ORDER BY fld_product_name DESC");
                        } elseif ($getSort == "priceAsc") {
                          $stmt = $conn->prepare("SELECT * FROM tbl_products_a175054 ORDER BY fld_product_price ASC");
                        } elseif ($getSort == "priceDesc") {
                          $stmt = $conn->prepare("SELECT * FROM tbl_products_a175054 ORDER BY fld_product_price DESC");
                        } 
                      } else {
                        $stmt = $conn->prepare("SELECT * FROM tbl_products_a175054 LIMIT $start_from, $per_page");
                      }
