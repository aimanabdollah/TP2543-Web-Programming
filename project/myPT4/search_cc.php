...
try {
    ...
    $stmt = $conn->prepare("SELECT * FROM tbl_products_a175054 WHERE (fld_product_name like '%".$_POST['sear1']."%') or (fld_product_brand like '%".$_POST['sear1']."%') or (fld_product_user_level like '%".$_POST['sear1']."%')");
    $stmt->execute();
      ...
      <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="caption">
                ...
                <p><strong>Type : </strong> <?php echo $readrow['fld_product_brand'] ?> </p>
                <p><strong>Size : </strong> <?php echo $readrow['fld_product_user_level'] ?> </p>
                <p><strong>Brand : </strong> <?php echo $readrow['fld_product_warranty_length'] ?></p> 
                <p><strong>Description : </strong> <?php echo $readrow['fld_product_quantity'] ?> </p>
