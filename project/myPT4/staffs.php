        ...
        <form action="staffs.php" method="post" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              ...
              <?php }
              if ($_SESSION['role'] == "Normal Staff") { ?>
                <input name="sid" type="email" class="form-control" readonly>
              <?php } ?>
            ...
            <tr>
              ...
              <td>  <center>
                <?php if ($_SESSION['role'] == "Supervisor") { ?>
                  ...
                  <a onclick=" confirm('You do not have right to delete staff named <?php echo $readrow['fld_staff_name']; ?>! This is illigal');" class="btn btn-danger btn-xs" role="button">Delete</a>
                <?php }
                if ($_SESSION['role'] == "Admin") { ?>
                  <a href="staffs.php?edit=<?php echo $readrow['fld_staff_num']; ?>" class="btn btn-success btn-xs" role="button">Edit</a>
