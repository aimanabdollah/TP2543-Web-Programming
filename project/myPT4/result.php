    ...
    <div class="container-fluid">
      <div class="row">
        ...
        try {
          ...
          $i = 0;
          $query = "SELECT * FROM tbl_products_a175054 WHERE ";
          ...
          foreach ($keyword as $term3) {
            $k++;
            if ($k == '1') {
              $query3 .= "fld_product_brand LIKE '%$term3%' ";
            } else {
              $query3 .= "OR fld_product_brand LIKE '%$term3%' ";
            }
          }
          //echo "$query3 <br>";
          ...
          $l = 0;
          $query4 = "";
          foreach ($keyword as $term4) {
            $l++;
            if ($l == '1') {
              $query4 .= "fld_product_user_level LIKE '%$term4%' ";
            } else {
              $query4 .= "OR fld_product_user_level LIKE '%$term4%' ";
            }
          }
          //echo "$query3 <br>";
        ...
        ?>
          ...
          <div class="col-xs-12 col-sm-4 col-md-4">
            <div class="thumbnail">
              ...
              <div class="caption">
                <strong>
                  <p style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><?php echo $readrow['fld_product_name'] ?></p>
                </strong>
                <p><b>Price:</b> RM<?php echo $readrow['fld_product_price'] ?></p>
                <p><b>Brand:</b> <?php echo $readrow['fld_product_brand'] ?></p>
                <p><b>User Level:</b> <?php echo $readrow['fld_product_user_level'] ?></p>
                <p>
