...
<body>
  <center>
    ...
    <form action="customers.php" method="post">
      ...
      Name
      <input name="fname" type="text" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_name']; ?>"> <br>
      Email
      <input name="email" type="email" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_email']; ?>"> <br>
      Phone Number
